...
.method public static createFromByteArray([BLX/7VV;)Lcom/facebook/animated/webp/WebPImage;
    .locals 1

    invoke-static {}, LX/2vY;->A00()V
...
.method public bridge synthetic getFrame(I)LX/8rn;
    .locals 1
...
.method public getFrameInfo(I)LX/7Me;
    .locals 9
    ...
    sget-object v3, LX/6yo;->A01:LX/6yo;
    ...
    sget-object v4, LX/6z1;->A02:LX/6z1;

    :goto_1
    new-instance v2, LX/7Me;

    invoke-direct/range {v2 .. v8}, LX/7Me;-><init>(LX/6yo;LX/6z1;IIII)V

    goto :goto_2

    :cond_0
    sget-object v4, LX/6z1;->A01:LX/6z1;

    goto :goto_1

    :cond_1
    sget-object v3, LX/6yo;->A02:LX/6yo;
