...
.method public final zza(Landroid/content/Intent;II)I
    ...
    :try_start_1
    sget-object v1, Lcom/google/android/gms/internal/gtm/zzfi;->zzb:LX/7fi;

    if-eqz v1, :cond_0

    invoke-virtual {v1}, LX/7fi;->A04()Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-virtual {v1}, LX/7fi;->A00()V
    ...
    :catch_0
    :goto_0
    invoke-static {p0}, LX/6LG;->A0b(Lcom/google/android/gms/internal/gtm/zzfn;)Lcom/google/android/gms/internal/gtm/zzfb;
    ...
    invoke-direct {v2, p0, p3, v4, v0}, LX/3jm;-><init>(Ljava/lang/Object;ILjava/lang/Object;I)V
