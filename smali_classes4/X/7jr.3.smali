...
.method public static constructor <clinit>()V
    ...
    sput-object v0, LX/7jr;->A04:Landroid/net/Uri;
    ...
    sput-object v0, LX/7jr;->A05:Landroid/net/Uri;
    ...
    sput-object v0, LX/7jr;->A0B:Ljava/util/regex/Pattern;
    ...
    sput-object v0, LX/7jr;->A0C:Ljava/util/regex/Pattern;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>()V

    sput-object v0, LX/7jr;->A0A:Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-static {}, LX/001;->A0y()Ljava/util/HashMap;

    move-result-object v0

    sput-object v0, LX/7jr;->A06:Ljava/util/HashMap;

    invoke-static {}, LX/001;->A0y()Ljava/util/HashMap;

    move-result-object v0

    sput-object v0, LX/7jr;->A07:Ljava/util/HashMap;

    invoke-static {}, LX/001;->A0y()Ljava/util/HashMap;

    move-result-object v0

    sput-object v0, LX/7jr;->A08:Ljava/util/HashMap;

    invoke-static {}, LX/001;->A0y()Ljava/util/HashMap;

    move-result-object v0

    sput-object v0, LX/7jr;->A09:Ljava/util/HashMap;

    const/4 v0, 0x0

    new-array v0, v0, [Ljava/lang/String;

    sput-object v0, LX/7jr;->A03:[Ljava/lang/String;
...
.method public static A00(Landroid/content/ContentResolver;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p0}, LX/7jr;->A01(Landroid/content/ContentResolver;)V

    sget-object v3, LX/7jr;->A00:Ljava/lang/Object;
    ...
    :cond_0
    sget-object v12, LX/7jr;->A03:[Ljava/lang/String;
    ...
    :cond_1
    sget-object v4, LX/7jr;->A01:Ljava/util/HashMap;

    sget-object v9, LX/7jr;->A05:Landroid/net/Uri;
    ...
    sget-object v9, LX/7jr;->A04:Landroid/net/Uri;
...
.method public static A01(Landroid/content/ContentResolver;)V
    ...
    sget-object v0, LX/7jr;->A0A:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    sput-object v0, LX/7jr;->A01:Ljava/util/HashMap;

    invoke-static {}, LX/001;->A0k()Ljava/lang/Object;

    move-result-object v0

    sput-object v0, LX/7jr;->A00:Ljava/lang/Object;

    sput-boolean v1, LX/7jr;->A02:Z

    sget-object v2, LX/7jr;->A04:Landroid/net/Uri;
    ...
    sget-object v0, LX/7jr;->A06:Ljava/util/HashMap;

    invoke-virtual {v0}, Ljava/util/AbstractMap;->clear()V

    sget-object v0, LX/7jr;->A07:Ljava/util/HashMap;

    invoke-virtual {v0}, Ljava/util/AbstractMap;->clear()V

    sget-object v0, LX/7jr;->A08:Ljava/util/HashMap;

    invoke-virtual {v0}, Ljava/util/AbstractMap;->clear()V

    sget-object v0, LX/7jr;->A09:Ljava/util/HashMap;
