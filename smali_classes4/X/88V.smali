...
.method public constructor <init>(LX/7Wf;)V
    ...
    iput-object p1, p0, LX/88V;->A00:LX/7Wf;
...
.method public BPP()V
    ...
    iget-object v8, p0, LX/88V;->A00:LX/7Wf;

    monitor-enter v8

    :try_start_0
    invoke-virtual {v8}, LX/7Wf;->A01()Ljava/io/File;
    ...
    invoke-virtual {v8, v5}, LX/7Wf;->A00(Ljava/io/File;)Lcom/whatsapp/watls13/WtPersistentSession;

    move-result-object v0

    if-eqz v0, :cond_2

    iget-object v0, v0, Lcom/whatsapp/watls13/WtPersistentSession;->A03:Ljava/util/LinkedHashSet;
