...
# static fields
.field public static final A01:LX/6e7;
...
.method public static constructor <clinit>()V
    ...
    invoke-direct {v1}, LX/6e7;-><init>()V

    sput-object v1, LX/6e7;->A01:LX/6e7;

    const/4 v0, 0x0

    iput-boolean v0, v1, LX/8Kz;->A00:Z

    sput-object v1, LX/6e7;->A02:LX/8vo;
...
.method public constructor <init>()V
    ...
    invoke-direct {p0, v0}, LX/6e7;-><init>(Ljava/util/ArrayList;)V
...
.method public constructor <init>(Ljava/util/ArrayList;)V
    ...
    iput-object p1, p0, LX/6e7;->A00:Ljava/util/List;
...
.method public static A00(Ljava/lang/Object;)Ljava/lang/String;
    ...
    sget-object v3, LX/7au;->A02:Ljava/nio/charset/Charset;
    ...
    iget-object v2, p0, LX/6eB;->zzb:[B
    ...
    sget-object v1, LX/7au;->A02:Ljava/nio/charset/Charset;
...
.method public final synthetic BrY(I)LX/8vs;
    ...
    iget-object v0, p0, LX/6e7;->A00:Ljava/util/List;

    invoke-virtual {v1, v0}, Ljava/util/AbstractCollection;->addAll(Ljava/util/Collection;)Z

    new-instance v0, LX/6e7;

    invoke-direct {v0, v1}, LX/6e7;-><init>(Ljava/util/ArrayList;)V
...
.method public final BsK()LX/8vo;
    ...
    iget-boolean v0, p0, LX/8Kz;->A00:Z

    if-eqz v0, :cond_0

    new-instance v0, LX/8L0;

    invoke-direct {v0, p0}, LX/8L0;-><init>(LX/8vo;)V
...
.method public final addAll(ILjava/util/Collection;)Z
    ...
    instance-of v0, p2, LX/8vo;

    if-eqz v0, :cond_0

    check-cast p2, LX/8vo;

    invoke-interface {p2}, LX/8vo;->BsF()Ljava/util/List;
...
.method public final synthetic get(I)Ljava/lang/Object;
    ...
    iget-object v4, p0, LX/6e7;->A00:Ljava/util/List;
    ...
    :cond_0
    instance-of v0, v6, LX/8D4;

    if-eqz v0, :cond_3

    check-cast v6, LX/8D4;

    sget-object v3, LX/7au;->A02:Ljava/nio/charset/Charset;

    invoke-virtual {v6}, LX/8D4;->A01()I
    ...
    invoke-virtual {v6}, LX/6eB;->A03()I

    move-result v3

    iget-object v2, v6, LX/6eB;->zzb:[B
    ...
    invoke-virtual {v0, v2, v3, v1}, LX/7U9;->A01([BII)I
    ...
    iget-object v2, v0, LX/6eB;->zzb:[B
    ...
    sget-object v2, LX/7Zo;->A00:LX/7U9;

    array-length v1, v6

    const/4 v0, 0x0

    invoke-virtual {v2, v6, v0, v1}, LX/7U9;->A01([BII)I
...
.method public final synthetic remove(I)Ljava/lang/Object;
    ...
    invoke-static {v1}, LX/6e7;->A00(Ljava/lang/Object;)Ljava/lang/String;
...
.method public final synthetic set(ILjava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {v0}, LX/6e7;->A00(Ljava/lang/Object;)Ljava/lang/String;
