...
.method public constructor <init>()V
    ...
    invoke-direct {p0, v0}, LX/8KV;-><init>(Z)V
...
.method public constructor <init>(Z)V
    ...
    iput-boolean p1, p0, LX/8KV;->A01:Z
...
.method public A00(Ljava/security/cert/X509Certificate;Ljava/util/List;LX/8EZ;)Ljava/security/cert/CertPathBuilderResult;
    ...
    iget-boolean v0, p0, LX/8KV;->A01:Z
    ...
    const/4 v1, 0x0
    :try_end_1
    .catch LX/72G; {:try_start_1 .. :try_end_1} :catch_5
    ...
    .catch LX/72G; {:try_start_2 .. :try_end_2} :catch_5
    ...
    goto/16 :goto_5
    :try_end_5
    .catch LX/72G; {:try_start_5 .. :try_end_5} :catch_5
    ...
    goto :goto_4
    :try_end_6
    .catch LX/72G; {:try_start_6 .. :try_end_6} :catch_5
    ...
    :try_end_7
    .catch LX/72G; {:try_start_7 .. :try_end_7} :catch_5
    ...
    .catch LX/72G; {:try_start_8 .. :try_end_8} :catch_5
    ...
    move-result-object v1
    :try_end_9
    .catch LX/72G; {:try_start_9 .. :try_end_9} :catch_5
    ...
    invoke-virtual {p0, v0, p2, p3}, LX/8KV;->A00(Ljava/security/cert/X509Certificate;Ljava/util/List;LX/8EZ;)Ljava/security/cert/CertPathBuilderResult;
    ...
    throw v0
    :try_end_b
    .catch LX/72G; {:try_start_b .. :try_end_b} :catch_5
    ...
    goto :goto_4
    :try_end_c
    .catch LX/72G; {:try_start_c .. :try_end_c} :catch_5
    ...
    throw v0
    :try_end_d
    .catch LX/72G; {:try_start_d .. :try_end_d} :catch_5

    :catch_5
    move-exception v0

    iput-object v0, p0, LX/8KV;->A00:Ljava/lang/Exception;
...
.method public engineBuild(Ljava/security/cert/CertPathParameters;)Ljava/security/cert/CertPathBuilderResult;
    ...
    invoke-virtual {p0, v0, v3, p1}, LX/8KV;->A00(Ljava/security/cert/X509Certificate;Ljava/util/List;LX/8EZ;)Ljava/security/cert/CertPathBuilderResult;
    ...
    iget-object v2, p0, LX/8KV;->A00:Ljava/lang/Exception;
    ...
    iget-object v0, p0, LX/8KV;->A00:Ljava/lang/Exception;
