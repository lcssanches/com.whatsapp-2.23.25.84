...
.method public A01(Landroid/content/Context;Landroid/content/res/Resources;LX/0Ku;I)Landroid/graphics/Typeface;
    ...
    :try_start_0
    iget-object v5, p3, LX/0Ku;->A00:[LX/0NI;
    ...
    invoke-static {v0, p4}, LX/05z;->A00(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
...
.method public A03(Landroid/content/Context;Landroid/os/CancellationSignal;[LX/0N3;I)Landroid/graphics/Typeface;
    ...
    :try_start_1
    iget-object v1, v8, LX/0N3;->A03:Landroid/net/Uri;
    ...
    iget v0, v8, LX/0N3;->A02:I

    invoke-virtual {v1, v0}, Landroid/graphics/fonts/Font$Builder;->setWeight(I)Landroid/graphics/fonts/Font$Builder;

    move-result-object v1

    iget-boolean v0, v8, LX/0N3;->A04:Z
    :try_end_2
