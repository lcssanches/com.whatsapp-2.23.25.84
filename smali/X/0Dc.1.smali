...
.method public A08()V
    ...
    iget-boolean v0, p0, LX/0Dc;->A00:Z

    if-nez v0, :cond_0

    const/4 v0, 0x1

    iput-boolean v0, p0, LX/0Dc;->A00:Z

    invoke-interface {p0}, LX/43G;->generatedComponent()Ljava/lang/Object;

    move-result-object v1

    check-cast v1, Lcom/whatsapp/info/views/EncryptionInfoView_GeneratedInjector;

    move-object v0, p0

    check-cast v0, Lcom/whatsapp/info/views/EncryptionInfoView;

    invoke-interface {v1, v0}, Lcom/whatsapp/info/views/EncryptionInfoView_GeneratedInjector;->BFL(Lcom/whatsapp/info/views/EncryptionInfoView;)V
