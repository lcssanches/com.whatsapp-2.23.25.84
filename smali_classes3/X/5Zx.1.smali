...
.method public constructor <init>(Landroid/text/TextPaint;Ljava/lang/CharSequence;I)V
    ...
    iput-object p2, p0, LX/5Zx;->A07:Ljava/lang/CharSequence;

    iput-object p1, p0, LX/5Zx;->A0B:Landroid/text/TextPaint;

    iput p3, p0, LX/5Zx;->A0A:I

    invoke-interface {p2}, Ljava/lang/CharSequence;->length()I

    move-result v0

    iput v0, p0, LX/5Zx;->A02:I

    sget-object v0, Landroid/text/Layout$Alignment;->ALIGN_NORMAL:Landroid/text/Layout$Alignment;

    iput-object v0, p0, LX/5Zx;->A05:Landroid/text/Layout$Alignment;

    const v0, 0x7fffffff

    iput v0, p0, LX/5Zx;->A04:I

    const/4 v0, 0x0

    iput v0, p0, LX/5Zx;->A00:F

    const/high16 v0, 0x3f800000    # 1.0f

    iput v0, p0, LX/5Zx;->A01:F

    sget v0, LX/5Zx;->A0F:I

    iput v0, p0, LX/5Zx;->A03:I

    const/4 v0, 0x1

    iput-boolean v0, p0, LX/5Zx;->A08:Z

    const/4 v0, 0x0

    iput-object v0, p0, LX/5Zx;->A06:Landroid/text/TextUtils$TruncateAt;
...
.method public A00()Landroid/text/StaticLayout;
    ...
    iget-object v7, p0, LX/5Zx;->A07:Ljava/lang/CharSequence;

    if-nez v7, :cond_0

    const-string v7, ""

    iput-object v7, p0, LX/5Zx;->A07:Ljava/lang/CharSequence;

    :cond_0
    iget v0, p0, LX/5Zx;->A0A:I
    ...
    iget v0, p0, LX/5Zx;->A04:I

    const/4 v5, 0x1

    if-ne v0, v5, :cond_1

    iget-object v2, p0, LX/5Zx;->A0B:Landroid/text/TextPaint;

    int-to-float v1, v4

    iget-object v0, p0, LX/5Zx;->A06:Landroid/text/TextUtils$TruncateAt;
    ...
    iget v0, p0, LX/5Zx;->A02:I

    invoke-static {v1, v0}, Ljava/lang/Math;->min(II)I

    move-result v2

    iput v2, p0, LX/5Zx;->A02:I
    ...
    iget-boolean v0, p0, LX/5Zx;->A09:Z
    ...
    :cond_2
    iget-object v0, p0, LX/5Zx;->A0B:Landroid/text/TextPaint;
    ...
    iget-object v0, p0, LX/5Zx;->A05:Landroid/text/Layout$Alignment;
    ...
    iget-boolean v0, p0, LX/5Zx;->A08:Z
    ...
    iget v1, p0, LX/5Zx;->A00:F

    cmpl-float v0, v1, v9

    if-nez v0, :cond_4

    iget v0, p0, LX/5Zx;->A01:F
    ...
    sput-object v0, LX/5Zx;->A0C:Ljava/lang/Object;
    ...
    invoke-static {v0, v8, v2}, LX/0yM;->A1C(Ljava/lang/Object;Ljava/lang/Object;[Ljava/lang/Object;)V
    ...
    sput-object v0, LX/5Zx;->A0D:Ljava/lang/reflect/Constructor;

    invoke-virtual {v0, v5}, Ljava/lang/reflect/AccessibleObject;->setAccessible(Z)V

    sput-boolean v5, LX/5Zx;->A0E:Z
    ...
    invoke-direct {v0, v1}, LX/71h;-><init>(Ljava/lang/Throwable;)V
    ...
    :goto_1
    :try_start_1
    sget-object v3, LX/5Zx;->A0D:Ljava/lang/reflect/Constructor;
    ...
    iget-object v1, p0, LX/5Zx;->A0B:Landroid/text/TextPaint;
    ...
    iget-object v1, p0, LX/5Zx;->A05:Landroid/text/Layout$Alignment;

    const/4 v0, 0x5

    aput-object v1, v2, v0

    sget-object v1, LX/5Zx;->A0C:Ljava/lang/Object;
