...
.field public A0O:LX/3jD;

.field public A0P:LX/5sm;

.field public A0Q:LX/5sm;

.field public A0R:LX/5su;

.field public A0S:LX/5sw;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {p0, p1}, LX/4L9;-><init>(Landroid/content/Context;)V

    invoke-static {p0}, LX/4L9;->A00(Lcom/whatsapp/mediaview/PhotoView;)V
    ...
    iput-object v0, p0, Lcom/whatsapp/mediaview/PhotoView;->A0Z:Ljava/lang/Runnable;

    invoke-virtual {p0}, Lcom/whatsapp/mediaview/PhotoView;->A03()V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {p0, p1, p2}, LX/4L9;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {p0, p1, p2, p3}, LX/4L9;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
...
.method public A02()V
    ...
    iput-object v3, p0, Lcom/whatsapp/mediaview/PhotoView;->A0N:LX/0Ni;

    iput-object v3, p0, Lcom/whatsapp/mediaview/PhotoView;->A0L:Landroid/view/ScaleGestureDetector;

    iput-object v3, p0, Lcom/whatsapp/mediaview/PhotoView;->A0J:Landroid/graphics/drawable/BitmapDrawable;
    ...
    iput-boolean v0, v1, LX/5sw;->A06:Z

    const/4 v0, 0x1

    iput-boolean v0, v1, LX/5sw;->A07:Z

    :cond_0
    iput-object v3, p0, Lcom/whatsapp/mediaview/PhotoView;->A0S:LX/5sw;

    iget-object v0, p0, Lcom/whatsapp/mediaview/PhotoView;->A0Q:LX/5sm;

    if-eqz v0, :cond_1

    invoke-static {v0}, LX/5sm;->A00(LX/5sm;)V

    :cond_1
    iput-object v3, p0, Lcom/whatsapp/mediaview/PhotoView;->A0Q:LX/5sm;

    iget-object v0, p0, Lcom/whatsapp/mediaview/PhotoView;->A0P:LX/5sm;
    ...
    :cond_2
    iput-object v3, p0, Lcom/whatsapp/mediaview/PhotoView;->A0P:LX/5sm;

    iget-object v0, p0, Lcom/whatsapp/mediaview/PhotoView;->A0R:LX/5su;

    if-eqz v0, :cond_3

    const/4 v2, 0x1

    iput-boolean v2, v0, LX/5su;->A02:Z

    iget-object v1, v0, LX/5su;->A03:Lcom/whatsapp/mediaview/PhotoView;
    ...
    invoke-virtual {v1, v2}, Lcom/whatsapp/mediaview/PhotoView;->A09(Z)V
    ...
    :cond_3
    iput-object v3, p0, Lcom/whatsapp/mediaview/PhotoView;->A0R:LX/5su;

    iget-object v1, p0, Lcom/whatsapp/mediaview/PhotoView;->A0O:LX/3jD;

    if-eqz v1, :cond_4

    const/4 v0, 0x1

    iput-boolean v0, v1, LX/3jD;->A02:Z

    :cond_4
    iput-object v3, p0, Lcom/whatsapp/mediaview/PhotoView;->A0O:LX/3jD;

    iput-object v3, p0, Lcom/whatsapp/mediaview/PhotoView;->A0M:Landroid/view/View$OnClickListener;
...
.method public final A03()V
    ...
    invoke-direct {v0, v2, p0}, LX/0Ni;-><init>(Landroid/content/Context;Landroid/view/GestureDetector$OnGestureListener;)V

    iput-object v0, p0, Lcom/whatsapp/mediaview/PhotoView;->A0N:LX/0Ni;
    ...
    invoke-direct {v1, v2, p0, p0, v0}, LX/4ER;-><init>(Landroid/content/Context;Landroid/view/ScaleGestureDetector$OnScaleGestureListener;Lcom/whatsapp/mediaview/PhotoView;I)V

    iput-object v1, p0, Lcom/whatsapp/mediaview/PhotoView;->A0L:Landroid/view/ScaleGestureDetector;
    ...
    invoke-direct {v0, p0}, LX/5sw;-><init>(Lcom/whatsapp/mediaview/PhotoView;)V

    iput-object v0, p0, Lcom/whatsapp/mediaview/PhotoView;->A0S:LX/5sw;

    const/4 v1, 0x1

    new-instance v0, LX/5sm;

    invoke-direct {v0, p0, v1}, LX/5sm;-><init>(Lcom/whatsapp/mediaview/PhotoView;I)V

    iput-object v0, p0, Lcom/whatsapp/mediaview/PhotoView;->A0Q:LX/5sm;
    ...
    iput-object v0, p0, Lcom/whatsapp/mediaview/PhotoView;->A0P:LX/5sm;

    new-instance v0, LX/5su;

    invoke-direct {v0, p0}, LX/5su;-><init>(Lcom/whatsapp/mediaview/PhotoView;)V

    iput-object v0, p0, Lcom/whatsapp/mediaview/PhotoView;->A0R:LX/5su;

    new-instance v0, LX/3jD;

    invoke-direct {v0, p0}, LX/3jD;-><init>(Lcom/whatsapp/mediaview/PhotoView;)V

    iput-object v0, p0, Lcom/whatsapp/mediaview/PhotoView;->A0O:LX/3jD;
...
.method public final A04(FF)V
    ...
    iget-object v8, p0, Lcom/whatsapp/mediaview/PhotoView;->A0M:Landroid/view/View$OnClickListener;

    if-eqz v8, :cond_0

    instance-of v0, v8, LX/5gq;

    if-eqz v0, :cond_2

    check-cast v8, LX/5gq;

    check-cast v8, LX/4xT;

    iget-object v6, v8, LX/4xT;->A00:LX/5Et;

    iget-object v5, v6, LX/5Et;->A01:Ljava/lang/Object;

    check-cast v5, Lcom/whatsapp/mediaview/PhotoView;

    invoke-virtual {v5}, Lcom/whatsapp/mediaview/PhotoView;->getPhoto()Landroid/graphics/Bitmap;
    ...
    iget-object v2, v6, LX/5Et;->A00:Ljava/lang/Object;
    ...
    iget-object v0, v8, LX/4xT;->A01:LX/1fU;

    invoke-static {v1, v0, v7, v3, v4}, LX/5Y3;->A01(LX/1Pt;LX/1fU;[F[FZ)Lcom/whatsapp/InteractiveAnnotation;

    move-result-object v0

    if-eqz v0, :cond_1

    invoke-static {v0, v2, v5}, Lcom/whatsapp/mediaview/MediaViewFragment;->A04(Lcom/whatsapp/InteractiveAnnotation;Lcom/whatsapp/mediaview/MediaViewFragment;Lcom/whatsapp/mediaview/PhotoView;)V
...
.method public final A05(FFF)V
    ...
    iput v6, p0, Lcom/whatsapp/mediaview/PhotoView;->A00:F
    ...
    invoke-virtual {p0, v3}, Lcom/whatsapp/mediaview/PhotoView;->A0A(Z)V
...
.method public A06(Landroid/graphics/Bitmap;)V
    ...
    :goto_0
    invoke-virtual {p0, v0}, Lcom/whatsapp/mediaview/PhotoView;->A07(Landroid/graphics/drawable/BitmapDrawable;)V
...
.method public A07(Landroid/graphics/drawable/BitmapDrawable;)V
    ...
    iget-object v0, p0, Lcom/whatsapp/mediaview/PhotoView;->A0J:Landroid/graphics/drawable/BitmapDrawable;
    ...
    :cond_2
    iput-object p1, p0, Lcom/whatsapp/mediaview/PhotoView;->A0J:Landroid/graphics/drawable/BitmapDrawable;

    invoke-virtual {p0, p1}, Landroid/widget/ImageView;->setImageDrawable(Landroid/graphics/drawable/Drawable;)V

    invoke-virtual {p0, v2}, Lcom/whatsapp/mediaview/PhotoView;->A09(Z)V
...
.method public A08(Z)V
    ...
    iput-boolean p1, p0, Lcom/whatsapp/mediaview/PhotoView;->A0Y:Z
...
.method public final A09(Z)V
    ...
    iget-object v1, p0, Lcom/whatsapp/mediaview/PhotoView;->A0J:Landroid/graphics/drawable/BitmapDrawable;
    ...
    iput v1, p0, Lcom/whatsapp/mediaview/PhotoView;->A05:F
    ...
    iget-boolean v4, p0, Lcom/whatsapp/mediaview/PhotoView;->A0T:Z
    ...
    iget v6, p0, Lcom/whatsapp/mediaview/PhotoView;->A02:F
    ...
    iget v1, p0, Lcom/whatsapp/mediaview/PhotoView;->A09:I
    ...
    invoke-static {v0, v1}, LX/001;->A00(FF)F
    ...
    iput v1, p0, Lcom/whatsapp/mediaview/PhotoView;->A00:F
...
.method public final A0A(Z)V
    ...
    iget-object v9, p0, Lcom/whatsapp/mediaview/PhotoView;->A0I:Landroid/graphics/RectF;

    iget-object v0, p0, Lcom/whatsapp/mediaview/PhotoView;->A0H:Landroid/graphics/RectF;

    invoke-virtual {v9, v0}, Landroid/graphics/RectF;->set(Landroid/graphics/RectF;)V

    iget-object v2, p0, Lcom/whatsapp/mediaview/PhotoView;->A0B:Landroid/graphics/Matrix;
    ...
    iget-object v3, p0, Lcom/whatsapp/mediaview/PhotoView;->A0P:LX/5sm;

    if-eqz v3, :cond_2

    iget-boolean v0, v3, LX/5sm;->A04:Z
    ...
    iput-wide v0, v3, LX/5sm;->A02:J

    iput v5, v3, LX/5sm;->A00:F

    iput v4, v3, LX/5sm;->A01:F

    iput-boolean v2, v3, LX/5sm;->A05:Z

    const/4 v0, 0x1

    iput-boolean v0, v3, LX/5sm;->A04:Z

    iget-object v2, v3, LX/5sm;->A03:Ljava/lang/Object;
...
.method public A0B()Z
    ...
    iget-boolean v0, v0, LX/5sm;->A04:Z
    ...
    :cond_0
    iget v2, p0, Lcom/whatsapp/mediaview/PhotoView;->A05:F
...
.method public getFullViewCroppedBitmap()Landroid/graphics/Bitmap;
    ...
    iget-boolean v0, p0, Lcom/whatsapp/mediaview/PhotoView;->A0T:Z
...
.method public onDoubleTap(Landroid/view/MotionEvent;)Z
    ...
    iget-object v4, p0, Lcom/whatsapp/mediaview/PhotoView;->A0S:LX/5sw;
    ...
    invoke-virtual/range {v4 .. v10}, LX/5sw;->A00(FFFFJ)V

    :cond_1
    iput-boolean v2, p0, Lcom/whatsapp/mediaview/PhotoView;->A0U:Z
...
.method public onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v0, p0, Lcom/whatsapp/mediaview/PhotoView;->A0K:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v2, p0, Lcom/whatsapp/mediaview/PhotoView;->A0K:Landroid/graphics/drawable/Drawable;
...
.method public onFling(Landroid/view/MotionEvent;Landroid/view/MotionEvent;FF)Z
    ...
    iget-object v2, p0, Lcom/whatsapp/mediaview/PhotoView;->A0Q:LX/5sm;

    if-eqz v2, :cond_0

    iget-boolean v0, v2, LX/5sm;->A04:Z

    if-nez v0, :cond_0

    const-wide/16 v0, -0x1

    iput-wide v0, v2, LX/5sm;->A02:J

    iput p3, v2, LX/5sm;->A00:F

    iput p4, v2, LX/5sm;->A01:F

    const/4 v0, 0x0

    iput-boolean v0, v2, LX/5sm;->A05:Z

    const/4 v0, 0x1

    iput-boolean v0, v2, LX/5sm;->A04:Z

    iget-object v0, v2, LX/5sm;->A03:Ljava/lang/Object;
...
.method public onLayout(ZIIII)V
    ...
    :cond_0
    invoke-virtual {p0, p1}, Lcom/whatsapp/mediaview/PhotoView;->A09(Z)V
...
.method public onScale(Landroid/view/ScaleGestureDetector;)Z
    ...
    invoke-virtual {p0, v2, v1, v0}, Lcom/whatsapp/mediaview/PhotoView;->A05(FFF)V
...
.method public onScaleEnd(Landroid/view/ScaleGestureDetector;)V
    ...
    iput-boolean v0, p0, Lcom/whatsapp/mediaview/PhotoView;->A0U:Z
...
.method public onScroll(Landroid/view/MotionEvent;Landroid/view/MotionEvent;FF)Z
    ...
    invoke-virtual {p0, v1, v0}, Lcom/whatsapp/mediaview/PhotoView;->A0C(FF)Z
...
.method public onSingleTapConfirmed(Landroid/view/MotionEvent;)Z
    ...
    iget-object v0, p0, Lcom/whatsapp/mediaview/PhotoView;->A0M:Landroid/view/View$OnClickListener;
    ...
    invoke-virtual {p0, v1, v0}, Lcom/whatsapp/mediaview/PhotoView;->A04(FF)V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v0, p0, Lcom/whatsapp/mediaview/PhotoView;->A0L:Landroid/view/ScaleGestureDetector;

    const/4 v4, 0x1

    if-eqz v0, :cond_3

    iget-object v0, p0, Lcom/whatsapp/mediaview/PhotoView;->A0N:LX/0Ni;
    ...
    iget-object v0, p0, Lcom/whatsapp/mediaview/PhotoView;->A0Z:Ljava/lang/Runnable;
...
.method public setAllowFullViewCrop(Z)V
    ...
    iput-boolean p1, p0, Lcom/whatsapp/mediaview/PhotoView;->A0T:Z
...
.method public setDoubleTapToZoomEnabled(Z)V
    ...
    iput-boolean p1, p0, Lcom/whatsapp/mediaview/PhotoView;->A0V:Z
...
.method public setIsLongpressEnabled(Z)V
    ...
    iget-object v0, v0, LX/0Ni;->A00:LX/0rJ;
...
.method public setOnClickListener(Landroid/view/View$OnClickListener;)V
    ...
    iput-object p1, p0, Lcom/whatsapp/mediaview/PhotoView;->A0M:Landroid/view/View$OnClickListener;
...
.method public setOverlay(Landroid/graphics/drawable/Drawable;)V
    ...
    iput-object p1, p0, Lcom/whatsapp/mediaview/PhotoView;->A0K:Landroid/graphics/drawable/Drawable;
