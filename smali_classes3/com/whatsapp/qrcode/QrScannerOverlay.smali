...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iget-boolean v0, p0, Lcom/whatsapp/qrcode/QrScannerOverlay;->A08:Z

    if-nez v0, :cond_0

    const/4 v0, 0x1

    iput-boolean v0, p0, Lcom/whatsapp/qrcode/QrScannerOverlay;->A08:Z

    invoke-virtual {p0}, Lcom/whatsapp/qrcode/QrScannerOverlay;->generatedComponent()Ljava/lang/Object;
    ...
    iput-object v0, p0, Lcom/whatsapp/qrcode/QrScannerOverlay;->A0E:Landroid/graphics/Paint;

    invoke-static {}, LX/001;->A0P()Landroid/graphics/Rect;

    move-result-object v0

    iput-object v0, p0, Lcom/whatsapp/qrcode/QrScannerOverlay;->A0G:Landroid/graphics/Rect;

    invoke-static {}, LX/002;->A03()Landroid/graphics/RectF;

    move-result-object v0

    iput-object v0, p0, Lcom/whatsapp/qrcode/QrScannerOverlay;->A0H:Landroid/graphics/RectF;

    const/4 v0, 0x0

    iput v0, p0, Lcom/whatsapp/qrcode/QrScannerOverlay;->A01:F

    sget-object v0, LX/5Ga;->A06:[I
    ...
    iput v2, p0, Lcom/whatsapp/qrcode/QrScannerOverlay;->A0D:I
    ...
    iput-object v2, p0, Lcom/whatsapp/qrcode/QrScannerOverlay;->A04:Landroid/graphics/drawable/Drawable;

    invoke-virtual {v2}, Landroid/graphics/drawable/Drawable;->getIntrinsicWidth()I

    move-result v1

    iget-object v0, p0, Lcom/whatsapp/qrcode/QrScannerOverlay;->A04:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v1, p0, Lcom/whatsapp/qrcode/QrScannerOverlay;->A0F:Landroid/graphics/Paint;
...
.method public final generatedComponent()Ljava/lang/Object;
    ...
    iget-object v0, p0, Lcom/whatsapp/qrcode/QrScannerOverlay;->A06:LX/5sB;
    ...
    iput-object v0, p0, Lcom/whatsapp/qrcode/QrScannerOverlay;->A06:LX/5sB;
...
.method public onAttachedToWindow()V
    ...
    invoke-direct {v2, p0}, LX/4Fi;-><init>(Lcom/whatsapp/qrcode/QrScannerOverlay;)V

    iput-object v2, p0, Lcom/whatsapp/qrcode/QrScannerOverlay;->A05:LX/4Fi;

    const-wide/16 v0, 0x7d0

    invoke-virtual {v2, v0, v1}, Landroid/view/animation/Animation;->setDuration(J)V

    iget-object v1, p0, Lcom/whatsapp/qrcode/QrScannerOverlay;->A05:LX/4Fi;
    ...
    iget-object v0, p0, Lcom/whatsapp/qrcode/QrScannerOverlay;->A05:LX/4Fi;
...
.method public onDraw(Landroid/graphics/Canvas;)V
    ...
    invoke-static {v3, v0}, LX/4C9;->A0C(Landroid/view/View;I)I
    ...
    iget v9, v3, Lcom/whatsapp/qrcode/QrScannerOverlay;->A01:F

    iget v8, v3, Lcom/whatsapp/qrcode/QrScannerOverlay;->A00:F

    add-float/2addr v9, v8

    iput v9, v3, Lcom/whatsapp/qrcode/QrScannerOverlay;->A01:F
    ...
    iput v0, v3, Lcom/whatsapp/qrcode/QrScannerOverlay;->A01:F

    :goto_0
    neg-float v1, v8

    iput v1, v3, Lcom/whatsapp/qrcode/QrScannerOverlay;->A00:F

    :cond_1
    iget v1, v3, Lcom/whatsapp/qrcode/QrScannerOverlay;->A0B:I

    move-object/from16 v13, p1

    invoke-virtual {v13, v1}, Landroid/graphics/Canvas;->drawColor(I)V

    iget-object v14, v3, Lcom/whatsapp/qrcode/QrScannerOverlay;->A0H:Landroid/graphics/RectF;
    ...
    iget v8, v3, Lcom/whatsapp/qrcode/QrScannerOverlay;->A0D:I
    ...
    iget-object v4, v3, Lcom/whatsapp/qrcode/QrScannerOverlay;->A0F:Landroid/graphics/Paint;

    move-object/from16 v18, v4

    invoke-virtual/range {v13 .. v18}, Landroid/graphics/Canvas;->drawArc(Landroid/graphics/RectF;FFZLandroid/graphics/Paint;)V

    iget-object v8, v3, Lcom/whatsapp/qrcode/QrScannerOverlay;->A0E:Landroid/graphics/Paint;

    invoke-static {v8}, LX/4C5;->A12(Landroid/graphics/Paint;)V

    iget v4, v3, Lcom/whatsapp/qrcode/QrScannerOverlay;->A0C:I
    ...
    iget v4, v3, Lcom/whatsapp/qrcode/QrScannerOverlay;->A0A:F
    ...
    iget v7, v3, Lcom/whatsapp/qrcode/QrScannerOverlay;->A01:F
    ...
    iget-object v6, v3, Lcom/whatsapp/qrcode/QrScannerOverlay;->A0E:Landroid/graphics/Paint;

    const/4 v0, -0x1

    invoke-static {v0, v6}, LX/4C2;->A0q(ILandroid/graphics/Paint;)V

    iget v0, v3, Lcom/whatsapp/qrcode/QrScannerOverlay;->A02:I
    ...
    iget-object v5, v3, Lcom/whatsapp/qrcode/QrScannerOverlay;->A0G:Landroid/graphics/Rect;
    ...
    :cond_3
    iget v1, v3, Lcom/whatsapp/qrcode/QrScannerOverlay;->A09:F

    iget-object v0, v3, Lcom/whatsapp/qrcode/QrScannerOverlay;->A0F:Landroid/graphics/Paint;
    ...
    iget-object v1, v3, Lcom/whatsapp/qrcode/QrScannerOverlay;->A04:Landroid/graphics/drawable/Drawable;
    ...
    :cond_4
    iput v15, v3, Lcom/whatsapp/qrcode/QrScannerOverlay;->A01:F
