...
.field public static final LOGGER_THREAD:LX/3m0;
...
.field public static connectivityInfoProvider:LX/3KO; = null
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lcom/whatsapp/util/Log;->LOGGER_THREAD:LX/3m0;
...
.method public static adorn(Ljava/lang/String;Ljava/lang/StringBuilder;)Ljava/lang/String;
    ...
    sget-object v0, Lcom/whatsapp/util/Log;->connectivityInfoProvider:LX/3KO;

    if-eqz v0, :cond_1

    iget-object v0, v0, LX/3KO;->A00:Ljava/util/concurrent/atomic/AtomicReference;
...
.method public static blockingLog(ILjava/lang/String;)V
    ...
    invoke-static {p1}, LX/0yU;->A0t(Ljava/lang/String;)Ljava/lang/StringBuilder;
...
.method public static compress()Ljava/io/File;
    ...
    invoke-static {v6}, LX/0yQ;->A0z(Ljava/io/File;)Ljava/lang/StringBuilder;
    ...
    invoke-static {v3, v0}, LX/0yU;->A0a(Ljava/lang/String;Ljava/lang/String;)Ljava/io/File;
    ...
    invoke-static {v2, v0, v1}, LX/36u;->A00(Ljava/io/File;Ljava/lang/String;Ljava/util/Date;)Ljava/lang/String;
    ...
    invoke-direct {v6, v3, v0}, Ljava/io/FileOutputStream;-><init>(Ljava/io/File;Z)V
    :try_end_2
    ...
    :cond_3
    invoke-static {v12}, LX/0yN;->A0N(Ljava/io/File;)Ljava/io/BufferedInputStream;
...
.method public static e(Ljava/lang/Throwable;)V
    ...
    invoke-static {v1, p0, v2, v0}, LX/0yR;->A1J(Ljava/lang/String;Ljava/lang/Throwable;II)V
...
.method public static flush()V
    ...
    :try_start_0
    const-string/jumbo v0, "log/flush/start"

    const/4 v3, 0x5

    invoke-static {v3, v0}, Lcom/whatsapp/util/Log;->blockingLog(ILjava/lang/String;)V

    sget-object v4, Lcom/whatsapp/util/Log;->LOGGER_THREAD:LX/3m0;
    ...
    iget-object v0, v4, LX/3m0;->A02:Ljava/util/concurrent/BlockingQueue;
    ...
    invoke-virtual {v4}, LX/3m0;->A00()V
    ...
    :cond_0
    sget-object v2, LX/3m0;->A05:Ljava/lang/Runnable;
    ...
    invoke-virtual {v4, v1}, LX/3m0;->A01(Ljava/lang/Object;)V
    ...
    :cond_1
    :try_start_2
    const-string/jumbo v0, "log/flush/logs written"

    invoke-static {v3, v0}, Lcom/whatsapp/util/Log;->blockingLog(ILjava/lang/String;)V

    const-string/jumbo v0, "log/flush/forcing to disk"
    ...
    const-string/jumbo v0, "log/flush/end"
    ...
    const-string/jumbo v0, "log/flush/failed"
...
.method public static getLatestLogs(I)Ljava/util/ArrayList;
    ...
    invoke-static {v0, v2}, LX/000;->A0U(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public static initialize()Z
    ...
    invoke-direct {v2, v0}, LX/1uB;-><init>(Ljava/io/OutputStream;)V
    ...
    invoke-direct {v1, v2, v0}, LX/1u8;-><init>(Ljava/io/OutputStream;Ljava/io/OutputStream;)V
...
.method public static logAdorned(Ljava/lang/String;Z)Ljava/lang/String;
    ...
    sget-object v0, Lcom/whatsapp/util/Log;->LOGGER_THREAD:LX/3m0;
    ...
    :cond_1
    invoke-virtual {v0, p0}, LX/3m0;->A01(Ljava/lang/Object;)V
...
.method public static logToLogcat(ILjava/lang/String;)V
    ...
    invoke-static {v0, v2, v4}, LX/000;->A0W(Ljava/lang/String;Ljava/lang/String;Ljava/lang/StringBuilder;)Ljava/lang/String;
...
.method public static rotate()Z
    ...
    invoke-static {v1}, LX/0yO;->A0f(Ljava/io/File;)Ljava/lang/StringBuilder;
