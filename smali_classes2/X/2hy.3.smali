...
.method public constructor <init>(LX/8sg;LX/43H;)V
    ...
    iput-object p1, p0, LX/2hy;->A03:LX/8sg;

    iput-object p2, p0, LX/2hy;->A04:LX/43H;
...
.method public final A00(LX/8wX;I)LX/43H;
    ...
    iget-object v1, p0, LX/2hy;->A00:LX/2PZ;
    ...
    :cond_0
    iget v1, v1, LX/2PZ;->A00:I

    if-gt p2, v1, :cond_2

    iget-object v1, p0, LX/2hy;->A02:[Ljava/util/Map;
...
.method public final A01()V
    ...
    :try_start_0
    iget-boolean v0, p0, LX/2hy;->A01:Z

    if-nez v0, :cond_f

    iget-object v5, p0, LX/2hy;->A03:LX/8sg;
    ...
    iget-object v0, p0, LX/2hy;->A04:LX/43H;
    ...
    :try_start_1
    iget-boolean v0, v2, LX/2n7;->A00:Z

    if-nez v0, :cond_0

    invoke-virtual {v2}, LX/2n7;->A0A()V

    const/4 v0, 0x1

    iput-boolean v0, v2, LX/2n7;->A00:Z
    :try_end_1
    ...
    :try_start_3
    iget-boolean v0, v1, LX/2n7;->A00:Z

    if-nez v0, :cond_3

    invoke-virtual {v1}, LX/2n7;->A0A()V

    const/4 v0, 0x1

    iput-boolean v0, v1, LX/2n7;->A00:Z
    :try_end_3
    .catchall {:try_start_3 .. :try_end_3} :catchall_0

    :cond_3
    :try_start_4
    iget-object v0, v1, LX/2n7;->A03:Ljava/util/List;
    :try_end_4
    ...
    iget-object v6, v2, LX/1WZ;->A05:Ljava/lang/Integer;

    iget-object v1, v2, LX/1WZ;->A06:LX/8wX;

    if-eqz v1, :cond_9

    if-eqz v6, :cond_7

    iget-object v0, v7, LX/2PZ;->A01:Ljava/util/ArrayList;

    invoke-static {v6, v1, v0}, LX/3gF;->A03(Ljava/lang/Object;Ljava/lang/Object;Ljava/util/AbstractCollection;)V

    invoke-virtual {v6}, Ljava/lang/Number;->intValue()I

    move-result v8

    iget v0, v7, LX/2PZ;->A00:I

    if-le v8, v0, :cond_4

    iput v8, v7, LX/2PZ;->A00:I

    :cond_4
    iget-object v6, v2, LX/1WZ;->A04:LX/1WT;
    ...
    iget-object v0, v6, LX/1WT;->A01:Ljava/util/List;
    ...
    :cond_5
    iget-object v0, v6, LX/1WT;->A00:Ljava/util/List;
    ...
    invoke-static {v0, v2, v3}, LX/3gF;->A03(Ljava/lang/Object;Ljava/lang/Object;Ljava/util/AbstractCollection;)V
    ...
    invoke-direct {v1, v0}, LX/3m5;-><init>(Ljava/lang/String;)V
    ...
    iput-object v7, p0, LX/2hy;->A00:LX/2PZ;
    ...
    :cond_b
    iput-object v1, p0, LX/2hy;->A02:[Ljava/util/Map;
    ...
    iget-object v0, p0, LX/2hy;->A02:[Ljava/util/Map;
    ...
    iput-boolean v0, p0, LX/2hy;->A01:Z
