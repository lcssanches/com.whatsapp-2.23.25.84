...
.method public constructor <init>(Ljava/util/zip/ZipEntry;Ljava/util/zip/ZipFile;)V
    ...
    iput-object p2, p0, LX/3F0;->A05:Ljava/util/zip/ZipFile;

    iput-object p1, p0, LX/3F0;->A04:Ljava/util/zip/ZipEntry;

    const/4 v0, 0x1

    iput-boolean v0, p0, LX/3F0;->A02:Z

    const-wide/16 v0, 0x0

    iput-wide v0, p0, LX/3F0;->A00:J

    invoke-virtual {p1}, Ljava/util/zip/ZipEntry;->getSize()J

    move-result-wide v0

    iput-wide v0, p0, LX/3F0;->A03:J

    invoke-virtual {p2, p1}, Ljava/util/zip/ZipFile;->getInputStream(Ljava/util/zip/ZipEntry;)Ljava/io/InputStream;

    move-result-object v0

    iput-object v0, p0, LX/3F0;->A01:Ljava/io/InputStream;
...
.method public Bgs(Ljava/nio/ByteBuffer;J)I
    ...
    iget-object v0, p0, LX/3F0;->A01:Ljava/io/InputStream;
    ...
    :cond_1
    iget-object v7, p0, LX/3F0;->A01:Ljava/io/InputStream;

    const-string v4, "\'s InputStream is null"

    if-eqz v7, :cond_7

    iget-wide v2, p0, LX/3F0;->A00:J
    ...
    iget-object v1, p0, LX/3F0;->A01:Ljava/io/InputStream;
    ...
    iget-object v0, p0, LX/3F0;->A05:Ljava/util/zip/ZipFile;

    iget-object v2, p0, LX/3F0;->A04:Ljava/util/zip/ZipEntry;
    ...
    iget-object v0, p0, LX/3F0;->A04:Ljava/util/zip/ZipEntry;
...
.method public isOpen()Z
    ...
    iget-boolean v0, p0, LX/3F0;->A02:Z
...
.method public read(Ljava/nio/ByteBuffer;)I
    ...
    iget-wide v0, p0, LX/3F0;->A00:J

    invoke-virtual {p0, p1, v0, v1}, LX/3F0;->Bgs(Ljava/nio/ByteBuffer;J)I
